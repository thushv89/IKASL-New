...
public abstract class InputParser {
    ...
    public ArrayList<double[]> normalizeWithBounds(ArrayList<double[]> inputs, double[] minBound, double[] maxBound) {
    ...
    private void normalizeVerticalWithStdDev(ArrayList<double[]> inputs) {
